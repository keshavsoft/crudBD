...
import { StartFunc as StartFuncGetFiles } from "./Laundry/getFiles.js";
import { StartFunc as StartFuncGetVariables } from "./Laundry/getVariables.js";

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

const SrcFolder = "Laundry";
...
// const root = resolve(__dirname, `./KCode/Laundry/viteConfig/${FrontEndSrcFolder}`);
const root = resolve(__dirname, `./${FrontEndSrcFolder}`);

let files = StartFuncGetFiles({ inRootFolder: `KCode/viteConfig/${FrontEndSrcFolder}` });
