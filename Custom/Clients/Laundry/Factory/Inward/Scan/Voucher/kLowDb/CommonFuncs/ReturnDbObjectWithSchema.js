...
let StartFunc = () => {
    ...
    LocalReturnData.UserDataFilePath = `${Configjson.jsonConfig.DataPath}/${Configjson.jsonConfig.DataPk}/EntryScan.json`;
...
let LocalFuncForTableSchema = () => {
    ...
    let LocalSecondNeeded = Configjson.jsonConfig.tableAndColumns.children.find(element => {
        return "children" in element === false && element.name === "EntryScan.json";
    });
